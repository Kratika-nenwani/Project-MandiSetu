    ...
    ; (option = null),
        ...
        (option = {
            ...
            xAxis: [
                {
                    type: 'category',
                    data: ['08-20', '08-21', '08-22', '08-23', '08-24'],
            ...
            series: [
                {
                    name: 'Min Price',
                    type: 'bar',
                    data: [9243.08, 8619.10, 9252.30, 9163.67, 15946.15]
                },
                {
                    name: 'Max Price',
                    type: 'bar',
                    data: [11639.17, 10933.04, 11491.88, 11586.77, 18883.00]
                },
                {
                    name: 'Modal Price',
                    type: 'line',
                    yAxisIndex: 1,
                    data: [10554.99, 9858.34, 10494.61, 10494.45, 18542.69]
                }
            ]
