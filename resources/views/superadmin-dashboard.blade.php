                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">SuperAdmin Dashboard</h4>
                        ...
                        <div class="card card-h-100">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <span class="text-muted mb-3 lh-1 d-block text-truncate">Total Wholesalers</span>
                                        <h4 class="mb-3">
                                            <span class="counter-value" data-target="120">0</span> Wholesalers
                                        </h4>
                                    </div>
                                    <div class="col-6">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        ...
                                        <h4 class="mb-3">
                                            <span class="counter-value" data-target="1500">0</span> Orders
                                        </h4>
                                    </div>
                                    <div class="col-6">
                                ...
                                <div class="text-nowrap">
                                    <span class="badge bg-danger-subtle text-danger">-50 Orders</span>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        ...
                                        <h4 class="mb-3">
                                            <span class="counter-value" data-target="50000">0</span> INR
                                        </h4>
                                    </div>
                                    <div class="col-6">
                                ...
                                <div class="text-nowrap">
                                    <span class="badge bg-warning-subtle text-warning">+5000 INR</span>
                                    <span class="ms-1 text-muted font-size-13">Since last month</span>
                                </div>
                            </div><!-- end card body -->
                        </div><!-- end card -->
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        ...
                                        <h4 class="mb-3">
                                            <span class="counter-value" data-target="30000">0</span> INR
                                        </h4>
                                    </div>
                                    <div class="col-6">
                                ...
                                <div class="text-nowrap">
                                    <span class="badge bg-success-subtle text-success">+4000 INR</span>
                                    <span class="ms-1 text-muted font-size-13">Since last week</span>
                                </div>
                            </div><!-- end card body -->
                        </div><!-- end card -->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8">
                        ...
                        <div class="card card-h-100">
                            <!-- card body -->
                            <div class="card-body">
                                <h5 class="card-title mb-4">Wholesaler Overview</h5>
                                <div class="table-responsive">
