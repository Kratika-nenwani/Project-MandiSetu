            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Commodity</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="card-title">Commodity List</h4>
                            {{-- <a href="{{ route('createcommodity') }}" class="btn btn-primary">
                            Create Commodity
                            </a> --}}
                        </div>
                        <div class="card-body">
...
<script type="text/javascript">
    ...
    $(this).removeClass('btn-primary edit').addClass('btn btn-outline-secondary save').html('<i class="fas fa-save"></i>');
        ...
        $(document).on('click', '.delete', function() {
            ...
            var url = "{{ route('delete-commodity') }}";
