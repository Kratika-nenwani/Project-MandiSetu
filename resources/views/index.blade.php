                        ...
                        <div class="col-xl-8">
                            ...
                            <div class="card card-h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-sm">
                                            <div id="invested-overview" data-colors='["#2ab57d", "#34c38f"]' class="apex-charts"></div>
                                        </div>
                                        <div class="col-sm align-self-center">
                                            <div class="mt-4 mt-sm-0">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-8">
                                    <div>
                                        <div id="market-overview" data-colors='["#2ab57d", "#34c38f"]' class="apex-charts"></div>
                                    </div>
                                </div>
                                <div class="col-xl-4">
                                    <div class="p-4">
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div id="sales-by-locations" data-colors='["#2ab57d"]' style="height: 250px"></div>
