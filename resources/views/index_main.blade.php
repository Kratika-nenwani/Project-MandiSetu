...
<body class="sidebar-enable">
    ...
    <div id="layout-wrapper">
            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="{{ Route('index_main') }}" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="{{ asset('assets/images/mandisetu.png') }}" alt="" height="24"
                                    id="logo-img">
                            </span>
                            <span class="logo-lg">
                                <img src="{{ asset('assets/images/mandilogo.png') }}" alt="" height="24">
                                <span class="logo-txt"></span>
                            </span>
                        </a>

                        <a href="{{ Route('index_main') }}" class="logo logo-light">
                            <span class="logo-sm">
        ...
        <div class="vertical-menu">
            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        @if (Auth::check() && Auth::user()->role == 'MandiVyapari')
                            <li>
                                <a href="{{ route('mandi-dashboard') }}">
                                    <i data-feather="home"></i>
                                    <span data-key="t-dashboard">Dashboard</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="{{ route('add-dukandar') }}">
                                    <i data-feather="user-plus"></i>
                                    <span data-key="t-dashboard">Add Shopkeepers</span>
                                </a>
                            </li>

                            <li>
                                <a href="{{ route('view-dukandar') }}">
                                    <i data-feather="users"></i>
                                    <span data-key="t-dashboard">View Shopkeepers</span>
                                </a>
                            </li>
                            ...
                            {{-- <li>
                                <a href="{{ route('sale-dukandar') }}">
                                    <i data-feather="shopping-cart"></i>
                                    <span data-key="t-dashboard">Sale Products</span>
                                </a>
                            </li> --}}
                            ...
                            <li>
                                <a href="{{ route('view-sales') }}">
                                    ...
                                    <span data-key="t-dashboard">View Sales</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="{{ route('view-stock') }}">
                                    ...
                                    <span data-key="t-dashboard">View Stock</span>
                                </a>
                            </li>
            ...
            <a href="{{ route('buy') }}">
                ...
                <span data-key="t-dashboard">Buy Product</span>
            </a>
        </li>
        <li>
                <a href="{{ route('sale-dukandar') }}">
 ...
 <li>
            <a href="{{ route('cart') }}">
                <i data-feather="shopping-cart"></i>
                <span data-key="t-dashboard">Cart</span>
            </a>
        </li>
        ...
        <li>
            <a href="{{ route('checkout') }}">
                ...
                <span data-key="t-dashboard">Checkout</span>
            </a>
        </li>
        <li>
                    ...
                    <span data-key="t-dashboard">My Orders</span>
                            ...
                            {{-- <li>
                                <a href="{{ route('buy') }}">
                                    ...
                                    <span data-key="t-dashboard">Buy</span>
                                </a>
                            </li> --}}
                        @endauth
                        @if (Auth::check() && Auth::user()->role == 'SuperAdmin')
                            ...
                            {{-- <li>
                                <a href="{{ route('createcommodity') }}">
                                    <i data-feather="plus-circle"></i> <!-- Updated icon -->
                                    <span data-key="t-dashboard">Add Commodity</span>
                                </a>
                            </li>
                            
                            <li>
                                <a href="{{ route('addvariety') }}">
                                    <i data-feather="tag"></i> <!-- Updated icon -->
                                    <span data-key="t-dashboard">Add Variety</span>
                                </a>
                            </li> --}}
                        ...
                        {{-- @if (Auth::check() && (Auth::user()->role == 'SuperAdmin' || Auth::user()->role == 'Wholesaler')) --}}
                        {{-- <li>
                                <a href="{{ route('commodity') }}">
                                    <i data-feather="package"></i> 
                                    <span data-key="t-dashboard">Create Quality</span>
                                </a>
                            </li> --}}
                        ...
                        <li>
                            @if (Auth::check() && (Auth::user()->role == 'SuperAdmin' || Auth::user()->role == 'Wholesaler'))
                                <a href="javascript: void(0);" class="has-arrow">
                                    <i data-feather="box"></i> <!-- Icon for Commodity -->
                                    <span data-key="t-apps">Commodity</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li>
                                        <a href="{{ route('viewcommodity') }}">
                                            <span data-key="t-calendar">View</span>
                                        </a>
                                    </li>
                            ...
                            @if (Auth::check() && Auth::user()->role == 'SuperAdmin')
                                    ...
                                    <li>
                                        <a href="{{ route('createcommodity') }}">
                                            <span data-key="t-dashboard">Add </span>
                                        </a>
                                    </li>
                ...
                <li>
                    @if (Auth::check() && (Auth::user()->role == 'SuperAdmin' || Auth::user()->role == 'Wholesaler'))
                        <a href="javascript: void(0);" class="has-arrow">
                            <i data-feather="layers"></i> <!-- Icon for Variety -->
                            <span data-key="t-apps">Variety</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li>
                                <a href="{{ route('viewvariety') }}">
                                    <span data-key="t-calendar">View</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="{{ route('addvariety') }}">
                                    <span data-key="t-calendar">Add</span>
                                </a>
                            </li>
        ...
        <li>
            <a href="{{ route('all-users') }}">
                ...
                <span data-key="t-dashboard">Wholesaler/Mandivyapari</span>
            </a>
        </li>
        ...
        <li>
            <a href="{{ route('purchase-request') }}">
                <i data-feather="shopping-cart"></i>
                <span data-key="t-dashboard">Purchase Request</span>
            </a>
        </li>
        
        <li>
            <a href="{{ route('view-banners') }}">
    ...
    @if (Auth::check() && Auth::user()->role == 'Wholesaler')
        <li>
            <a href="javascript: void(0);" class="has-arrow">
                <i data-feather="check-circle"></i> <!-- Icon for Quality -->
                <span data-key="t-apps">Quality</span>
            </a>
            <ul class="sub-menu" aria-expanded="false">
                <li>
    ...
    @if ((Auth::check() && Auth::user()->role == 'Wholesaler'))
        ...
        {{-- <li>
                                <a href="{{ route('invoice') }}">
                                    <i data-feather="file-text"></i>
                                    <span data-key="t-dashboard">Invoice</span>
                                </a>
                            </li> --}}
    @endauth
